...
export const SETTINGS: SettingDef[] = [
  ...
  },
  {
    ...
    section: "microphone",
    label: "Software Echo",
    hint: "Mix the mics into the room's speakers through the app. Leave off when a hardware mixer is doing it.",
  ...
  },
  {
    ...
    section: "microphone",
    label: "Pitch Gate",
    hint: "Use when a mixer's echo/reverb bleeds into the mic channels and an idle mic ghost-draws the active singer's melody on the piano roll.",
  ...
  },
  {
    ...
    hint: "Raise until the idle mic stops drawing, then stop — too high and it starts cutting quiet singing too. Takes effect immediately, so it can be dialled in mid-song.",
  ...
  },
  {
    ...
    section: "session",
    label: "Intermission",
    hint: "Cut to a fullscreen queue screen for a few seconds between songs, like a real karaoke machine.",
